...
[source, java]
.src/main/java/micronaut/cache/hazelcast/service/MessageService.java
----
include::{sourceDir}/src/main/java/micronaut/cache/hazelcast/service/MessageService.java[]
----
