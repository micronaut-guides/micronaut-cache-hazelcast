...
[source, java]
.src/test/java/micronaut/cache/hazelcast/service/MessageServiceSpec.java
----
include::{sourceDir}/src/test/java/micronaut/cache/hazelcast/service/MessageServiceSpec.java[tag=test]
}
----
