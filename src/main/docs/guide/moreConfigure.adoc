...
[source, java]
.src/main/java/micronaut/cache/hazelcast/service/HazelcastCacheAdditionalSettings.java
----
include::{sourceDir}/src/main/java/micronaut/cache/hazelcast/service/HazelcastCacheAdditionalSettings.java[]
----
